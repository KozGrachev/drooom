...
app.get('/hello', (req, res) => {
  console.log('opening existing session...', req.params());
  joinNewRoom(req.params());
})

app.get('/', (req, res) => {
  console.log('hello world');
  res.send('WOOOHOO A GET REQUEST')
})
